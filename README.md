...
Este tutorial foi feito por mim, Erika Bueno, como um complemento para a palestra ministrada no International Women's Day Rio de Janeiro 2019. Qualquer dúvida, entre em contato comigo via [e-mail](mailto:erbuen@protonmail.com) ou [Telegram](http://t.me/erbuen) :)
...
2. Na seção “VirtualBox 6.0.4 platform packages” escolha o que se adequa ao seu sistema operacional. Se você usa Windows, escolha “Windows hosts” e o download iniciará automaticamente (aprox. 220 MB). Se você usa distribuições Linux diferentes do Ubuntu, escolha “Linux distributions”, na tela seguinte escolha sua distribuição e o download iniciará (aprox. 143 MB para o Fedora).
...
2. Na seção “Ubuntu Desktop”, clique em “18.04 LTS”. O download deve iniciar automaticamente (aprox. 2 GB), caso isso não ocorra, clique em “download now” na tela de agradecimento.
...
Teste o REPL digitando códigos em Swift. Você encontra alguns exemplos neste repositório.
